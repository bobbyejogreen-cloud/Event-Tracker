...
function buildEventBody(eventInfo, extracted) {
  ...
  return {
    ...
    start: {
      date: extracted.start_date,
    },
    end: {
      // Google Calendar end date is exclusive, so add 1 day
      date: addOneDay(extracted.end_date || extracted.start_date),
    },
...
module.exports = { upsertCalendarEvent, createCalendarEvent, updateCalendarEvent };
